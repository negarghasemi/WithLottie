...
using WithLottie.Views;
using WithLottie.ViewModels;
using Xamarin.Forms;
...
namespace XamApp
{
    public partial class App : BitApplication
    {
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            await NavigationService.NavigateAsync("/Nav/LoginView");
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry, ContainerBuilder containerBuilder, IServiceCollection services)
        {
            ...
            containerRegistry.RegisterForNav<LoginView, LoginViewModel>("LoginView");
            containerRegistry.RegisterForNav<LoadingView, LoadingViewModel>("LoadingView");
